...
export default function CreateOrder() {
  ...
  const handleSubmit = async () => {
    ...
    const orderData = {
      ...
      organization: formData.congty || "Khách lẻ",
    };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formBox}>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Tên công ty định danh <Text style={styles.required}>*</Text></Text>
          <TextInput
            style={styles.input}
            value={formData.congty}
            onChangeText={(value) => handleInputChange('congty', value)}
